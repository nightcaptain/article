...
//            System.out.println("hour=" + hour + ",min=" + min);    
        ...
        retList.add(String.valueOf(day));
        retList.add(String.valueOf(hour));
        retList.add(String.valueOf(min));
        retList.add(String.valueOf(sec));
        return retList;
	}  
    ...
    static SimpleDateFormat sdfmT = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss");
    ...
    **/
	...
	public static void main1(String[] args)
	{
		try
		{
			...
			System.out.println(DateUtil.getSpecDate("yyyyMMdd", 0, 0, -1));
		}
		catch (Exception ex)
		{
			ex.printStackTrace();
...
//		String nowTime = strTemp.substring(8,14);
    ...
    * @return 当前日期是星期几
    */
   public static int getWeekIdx(Date dt) {
       Calendar cal = Calendar.getInstance();
       cal.setTime(dt);
	...
	/**@return 将字符性日期格式转换成DATE
	 * 
	*/
	public static Date longTimeToDate(String fFormatStr){
		try{
			return sdfLongTime.parse(fFormatStr);
		} catch (Exception e) {
			return null;
		}
	}
	 ...
	 */
	public static String getMonthFirstDay(String dateStr,String inFormat,String outFormat) throws ParseException{
	 ...
	 * @throws ParseException 
	 */
	public static String getMonthLastDay(String dateStr,String inFormat,String outFormat) throws ParseException{
		SimpleDateFormat sdf=new SimpleDateFormat(inFormat);
		Date date =sdf.parse(dateStr);
	 ...
	 * @throws ParseException
	 */
	public static String getNextMonthFirstDay(String dateStr,String inFormat,String outFormat) throws ParseException{
		Calendar cl=Calendar.getInstance();
		cl.setTime(new SimpleDateFormat(inFormat).parse(dateStr));
		cl.set(Calendar.MONTH, cl.get(Calendar.MONTH)+1);
		cl.set(Calendar.DAY_OF_MONTH, 1);
		
		return new SimpleDateFormat(outFormat).format(cl.getTime());
	}
	/**
	 * 得到下一天
	 * @param dateStr
	 ...
	 * @throws ParseException
	 */
	public static String getNextDay(String dateStr,String inFormat,String outFormat) throws ParseException{
		Calendar cl=Calendar.getInstance();
		cl.setTime(new SimpleDateFormat(inFormat).parse(dateStr));
	 ...
	 * @throws ParseException
	 */
	public static String parseStrToStr(String dateStr,String inFormat,String outFormat) throws ParseException{
